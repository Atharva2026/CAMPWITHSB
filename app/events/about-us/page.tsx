...
export default function AboutUs() {
  const companyValues = [
    ...
    },
    {
      title: "Integrity",
      description:
        "We are committed to maintaining the highest standards of ethical conduct in all our camps and events",
      icon: "⭐",
    },
    {
      title: "Growth",
    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.whoWeAre}>
          <p>
            VOICE Pune is a community-driven organization that brings together people who are passionate about learning
            and evolving. Our camps and events are carefully curated to foster growth in various areas, including
            education, spirituality, personal development, and mindfulness.
          </p>
          <p>
            We believe in the power of shared experiences and the importance of community, which is why we design our
            programs to be both impactful and accessible to people of all backgrounds. Our goal is to provide an
            enriching environment where individuals can learn, grow, and connect with others on their personal journeys.
          </p>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.getInvolved}>
          <p>
            We invite you to join us on this incredible journey of learning and growth. Explore our upcoming camps and
