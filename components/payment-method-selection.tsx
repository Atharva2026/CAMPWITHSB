...
export function PaymentMethodSelection({ onSelectMethod, onCancel, disableUPI }) {
  return (
    <div style={styles.overlay}>
      <div style={styles.popup}>
        <div style={styles.header}>
          <h3 style={styles.title}>Select Payment Method</h3>
          <button onClick={onCancel} style={styles.closeButton} aria-label="Close">
            ×
          </button>
        </div>
        <div style={styles.methodContainer}>
          <button
            ...
            style={{
              ...styles.methodButton,
              opacity: disableUPI ? 0.5 : 1,
              cursor: disableUPI ? "not-allowed" : "pointer",
            }}
            disabled={disableUPI}
          >
            ...
            <div style={styles.methodInfo}>
              ...
              <span style={styles.methodDesc}>2% processing fee will be applied.</span>
            </div>
          </button>
          <button onClick={() => onSelectMethod("idt")} style={styles.methodButton} className="idt-button">
            ...
            <div style={styles.methodInfo}>
              ...
              <span style={styles.methodDesc}>
                Collect auth. passcode from Central Voice <br></br>
                (HG Dayalu nitai pr)
              </span>
            </div>
          </button>
